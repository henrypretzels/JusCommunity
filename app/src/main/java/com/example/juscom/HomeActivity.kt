...
class HomeActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener{
    ...
    private fun setupUserInfo() {
        // Configura as informações do usuário (dados de exemplo)
   ...
   private fun setupSearch() {
    ...
    private fun getSampleRooms(): List<Room> {
        // Retorna a lista de salas de exemplo, já ordenada.
        return listOf(
    ...
    private fun setupClickListeners() {
     ...
     override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.nav_profile -> Toast.makeText(this, "Perfil selecionado", Toast.LENGTH_SHORT).show()
            R.id.nav_settings -> Toast.makeText(this, "Configurações selecionadas", Toast.LENGTH_SHORT).show()
            R.id.nav_help -> Toast.makeText(this, "Ajuda selecionada", Toast.LENGTH_SHORT).show()
            R.id.nav_logout -> {
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                if (drawerLayout.isDrawerOpen(GravityCompat.START)) {
                    ...
                    // Desabilita este callback e chama o comportamento padrão.
                    isEnabled = false
